...
// new nodes are added in the beginning of the linked list
...
void linked_list::add_node(int data)
{
	...
	newptr = new node;
	newptr->info = data;
	newptr->link = start; // make the new node point to first node
	start = newptr; // make new node as the first node in the list
}
